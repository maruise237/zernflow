...
assertContains(dashboardLayout, "normalizeWorkspace", "dashboard layout resilience");
assertContains(dashboardError, "Le dashboard n'a pas pu charger", "dashboard error boundary");
