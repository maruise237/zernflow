...
assertContains(aiResponseNode, "CURRENT_USER_MESSAGE", "AI current-message focus");
assertContains(aiResponseNode, "Do not answer older messages", "AI current-message guardrail");
...
assertContains(aiPanel, "Historique secondaire", "AI response panel context copy");
